CREATE TABLE IF NOT EXISTS guests (
    guest_id INT GENERATED BY DEFAULT AS UNIQUE IDENTITY,
...
CREATE TABLE IF NOT EXISTS passes (
    pass_id INT GENERATED BY DEFAULT AS UNIQUE IDENTITY,
...
CREATE TABLE IF NOT EXISTS payments (
    payment_id INT GENERATED BY DEFAULT AS UNIQUE IDENTITY,
    guest_id INT NOT NULL REFERENCES guests(guest_id),
...
CREATE TABLE IF NOT EXISTS visits (
    visit_id INT GENERATED BY DEFAULT AS UNIQUE IDENTITY,
    guest_id INT NOT NULL REFERENCES guests(guest_id),
    pass_id INT REFERENCES passes(pass_id),
    creation_time TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP
);
