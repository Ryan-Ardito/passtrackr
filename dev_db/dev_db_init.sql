...
CREATE TABLE IF NOT EXISTS guests (
    first_last VARCHAR(101) GENERATED ALWAYS AS (first_name || ' ' || last_name) STORED,
...
CREATE INDEX IF NOT EXISTS idx_first_last ON guests USING gin (first_last gin_trgm_ops);
