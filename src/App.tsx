...
function passReducer(pass_data: PassData, action: PassAction): PassData {
  switch (action.type) {
    ...
    case Msg.SetFirstName: { return { ...pass_data, first_name: action.data } }
    case Msg.SetLastName: { return { ...pass_data, last_name: action.data } }
    case Msg.SetTown: { return { ...pass_data, town: action.data } }
    case Msg.SetPasstype: { return { ...pass_data, passtype: action.data } }
    case Msg.SetActive: { return { ...pass_data, active: action.data } }
    case Msg.SetNotes: { return { ...pass_data, notes: action.data } }
  }
}
